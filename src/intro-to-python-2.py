...
# which number is the largest of the three.
# 1. Understand
# A input should promt the user to enter the numbers
# We need to compare each of the numbers and the largest will be print out

# 2. Plan
# Implement an input
# set the values to a varialble
# Iterate through the list
# order from high to low
# print the first element in the list
# 3. Execute
x = input("Enter three unique numbers:")
